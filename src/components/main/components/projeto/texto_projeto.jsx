    ...
    >
      <div className="w-[40vw] max-lg:w-[90vw]">
        ...
        <span className="text-[#FFFFFFCC] text-[18px] font-normal">
          ...
          campus.<br /><br />Essas iniciativas incluem a modernização dos sistemas de
          rede, assegurando maior velocidade e confiabilidade na conexão; a
          ...
          tecnológicas do setor educacional.<br /><br />Esses esforços visam não apenas
          aprimorar o suporte às atividades acadêmicas e administrativas, mas
          também criar um ambiente propício ao desenvolvimento de projetos de
          pesquisa, inovação e extensão, fortalecendo a posição do campus como
          um polo de excelência tecnológica e educacional na região.
        </span>
      </div>
      <div className="">
